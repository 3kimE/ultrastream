...
// This is the ROOT not-found, rendered outside the [locale] layout.
// The [locale] layout normally provides <html>/<body>, so this page
// must supply them itself or Next.js throws "Missing html and body tags".
